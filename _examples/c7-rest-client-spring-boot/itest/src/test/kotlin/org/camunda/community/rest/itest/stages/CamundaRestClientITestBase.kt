...
abstract class CamundaRestClientITestBase<SERVICE : Any, ACTION : ActionStage<ACTION, SERVICE>, ASSERT : AssertStage<ASSERT, SERVICE>> :
  SpringScenarioTest<ACTION, ACTION, ASSERT>(), ApplicationContextInitializer<ConfigurableApplicationContext> {
  ...
  companion object {
    ...
    fun feignProperties(registry: DynamicPropertyRegistry) {
  ...
  override fun initialize(applicationContext: ConfigurableApplicationContext) {
    val testValues = TestPropertyValues.of("feign.client.config.default.url=http://${camundaContainer.host}:${camundaContainer.firstMappedPort}/engine-rest/")
    testValues.applyTo(applicationContext.environment)
  }
