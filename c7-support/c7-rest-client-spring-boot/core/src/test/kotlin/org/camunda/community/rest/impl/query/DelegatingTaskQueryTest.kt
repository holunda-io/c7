...
class DelegatingTaskQueryTest {
  ...
  val query = DelegatingTaskQuery(
    ...
    this.taskVariableValueLike("taskVar", "value")
    this.taskVariableValueEquals("taskVar", "value")
    this.taskVariableValueNotEquals("taskVar", "value")
    this.taskVariableValueLessThan("taskVar", "value")
    this.taskVariableValueLessThanOrEquals("taskVar", "value")
    this.taskVariableValueGreaterThan("taskVar", "value")
    this.taskVariableValueGreaterThanOrEquals("taskVar", "value")
    this.processVariableValueLike("processVar", "value")
    this.processVariableValueEquals("processVar", "value")
    this.processVariableValueNotEquals("processVar", "value")
    this.processVariableValueLessThan("processVar", "value")
    this.processVariableValueLessThanOrEquals("processVar", "value")
    this.processVariableValueGreaterThan("processVar", "value")
    this.processVariableValueGreaterThanOrEquals("processVar", "value")
    this.caseInstanceVariableValueLike("caseVar", "value")
    this.caseInstanceVariableValueEquals("caseVar", "value")
    this.caseInstanceVariableValueNotEquals("caseVar", "value")
    this.caseInstanceVariableValueLessThan("caseVar", "value")
    this.caseInstanceVariableValueLessThanOrEquals("caseVar", "value")
    this.caseInstanceVariableValueGreaterThan("caseVar", "value")
    this.caseInstanceVariableValueGreaterThanOrEquals("caseVar", "value")
