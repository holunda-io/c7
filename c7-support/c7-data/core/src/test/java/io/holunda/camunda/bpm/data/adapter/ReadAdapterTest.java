...
public class ReadAdapterTest {
  ...
  public void getOrDefault_returns_value_although_default_is_given() {
    assertThat(FOO.from(builder().set(FOO, "hello").build()).getOrDefault("bar")).isEqualTo("hello");
  }
  ...
  public void getOrNull_returns_value_if_exists() {
    assertThat(FOO.from(builder().set(FOO, "hello").build()).getOrNull()).isEqualTo("hello");
  }
