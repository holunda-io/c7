...
object CamundaBpmData {
   ...
   */
  @JvmStatic
  @Deprecated(message = "Moved to dedicated Writers.C7.builder()", replaceWith = ReplaceWith(expression = "Writers.C7.builder"), level = DeprecationLevel.WARNING)
   ...
   */
  @JvmStatic
  @Deprecated(message = "Moved to dedicated Writers.C7.writer()", replaceWith = ReplaceWith(expression = "Writers.C7.writer"), level = DeprecationLevel.WARNING)
  fun writer(variables: VariableMap): GlobalVariableWriter<*> = Writers.C7.writer(variables)
  ...
  @JvmStatic
  @Deprecated(message = "Moved to dedicated Writers.C7.writer()", replaceWith = ReplaceWith(expression = "Writers.C7.writer"), level = DeprecationLevel.WARNING)
  fun writer(variableScope: VariableScope): VariableWriter<*> = Writers.C7.writer(variableScope)
  ...
  @JvmStatic
  @Deprecated(message = "Moved to dedicated Writers.C7.writer()", replaceWith = ReplaceWith(expression = "Writers.C7.writer"), level = DeprecationLevel.WARNING)
  fun writer(runtimeService: RuntimeService, executionId: String): VariableWriter<*> = Writers.C7.writer(runtimeService, executionId)
  ...
  @JvmStatic
  @Deprecated(message = "Moved to dedicated Writers.C7.writer()", replaceWith = ReplaceWith(expression = "Writers.C7.writer"), level = DeprecationLevel.WARNING)
  fun writer(taskService: TaskService, taskId: String): VariableWriter<*> = Writers.C7.writer(taskService, taskId)
  ...
  @JvmStatic
  @Deprecated(message = "Moved to dedicated Writers.C7.writer()", replaceWith = ReplaceWith(expression = "Writers.C7.writer"), level = DeprecationLevel.WARNING)
  fun writer(caseService: CaseService, caseExecutionId: String): VariableWriter<*> = Writers.C7.writer(caseService, caseExecutionId)
   ...
   */
  @JvmStatic
  @Deprecated(message = "Moved to dedicated Readers.C7.reader()", replaceWith = ReplaceWith(expression = "Readers.C7.reader"), level = DeprecationLevel.WARNING)
  fun reader(taskService: TaskService, taskId: String): VariableReader = Readers.C7.reader(taskService, taskId)
  ...
  @JvmStatic
  @Deprecated(message = "Moved to dedicated Readers.C7.reader()", replaceWith = ReplaceWith(expression = "Readers.C7.reader"), level = DeprecationLevel.WARNING)
  fun reader(runtimeService: RuntimeService, executionId: String): VariableReader = Readers.C7.reader(runtimeService, executionId)
  ...
  @JvmStatic
  @Deprecated(message = "Moved to dedicated Readers.C7.reader()", replaceWith = ReplaceWith(expression = "Readers.C7.reader"), level = DeprecationLevel.WARNING)
  fun reader(caseService: CaseService, caseExecutionId: String): VariableReader = Readers.C7.reader(caseService, caseExecutionId)
  ...
  @JvmStatic
  @Deprecated(message = "Moved to dedicated Readers.C7.reader()", replaceWith = ReplaceWith(expression = "Readers.C7.reader"), level = DeprecationLevel.WARNING)
  fun reader(variableScope: VariableScope): VariableReader = Readers.C7.reader(variableScope)
  ...
  @JvmStatic
  @Deprecated(message = "Moved to dedicated Readers.C7.reader()", replaceWith = ReplaceWith(expression = "Readers.C7.reader"), level = DeprecationLevel.WARNING)
  fun reader(variableMap: VariableMap): VariableReader = Readers.C7.reader(variableMap)
  ...
  @JvmStatic
  @Deprecated(message = "Moved to dedicated Readers.C7.reader()", replaceWith = ReplaceWith(expression = "Readers.C7.reader"), level = DeprecationLevel.WARNING)
  fun reader(processInstance: ProcessInstanceWithVariables): VariableReader = Readers.C7.reader(processInstance)
  ...
  @JvmStatic
  @Deprecated(message = "Moved to dedicated Readers.C7.reader()", replaceWith = ReplaceWith(expression = "Readers.C7.reader"), level = DeprecationLevel.WARNING)
  fun reader(lockedExternalTask: LockedExternalTask): VariableReader = Readers.C7.reader(lockedExternalTask)
}
